...
BUILD_INCLUDE='[{"platform": "amd64", "runs-on": "ubuntu-24.04-4", "alpine-arch": "x86_64", "docker-debian-os": "bookworm"}, {"platform": "arm64", "runs-on": "ubuntu-24.04-4", "alpine-arch": "aarch64", "docker-debian-os": "bookworm"}]'
