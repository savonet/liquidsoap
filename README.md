...
| --------|----------------|-----------|-----------------|
| `2.4.x` | [2.4.0](https://github.com/savonet/liquidsoap/releases/tag/v2.4.0) (docker: `savonet/liquidsoap:v2.4.0`)| ✅ | [2.4.x](https://github.com/savonet/liquidsoap/releases/tag/rolling-release-v2.4.x) (docker: `savonet/liquidsoap:rolling-release-v2.4.x` |
