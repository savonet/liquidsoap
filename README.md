...
| --------|----------------|-----------|-----------------|
| `2.2.x` | [2.2,0](https://github.com/savonet/liquidsoap/releases/tag/v2.2.0) (docker: [savonet/liquidsoap:v2.2.0](https://hub.docker.com/r/savonet/liquidsoap)| ✅ | [2.2.1](https://github.com/savonet/liquidsoap/releases/tag/rolling-release-v2.2.1) (docker: [savonet/liquidsoap:rolling-release-v2.2.1](https://hub.docker.com/r/savonet/liquidsoap)) |
