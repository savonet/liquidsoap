...
;; Copyright (C) 2003-2021 Samuel Mimram
...
(defvar liquidsoap-font-lock-keywords
 '(
   ...
   ("\\<\\(fun\\|def\\|rec\\|replaces\\|begin\\|end\\|if\\|then\\|else\\|elsif\\|let\\|try\\|catch\\|while\\|for\\|in\\|to\\|do\\|open\\|match\\|case\\)\\>\\|->\\|;" . font-lock-keyword-face)
