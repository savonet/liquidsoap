...
static inline void jack_sem_init(jack_sem_t *s) {
  *s = CreateSemaphore(NULL, 0, LONG_MAX, NULL);
}
static inline void jack_sem_post(jack_sem_t *s) {
  ReleaseSemaphore(*s, 1, NULL);
}
static inline void jack_sem_wait(jack_sem_t *s) {
