...
int32_t mp4ff_total_tracks(const mp4ff_t *f) { return f->total_tracks; }
...
int64_t mp4ff_get_track_duration_use_offsets(const mp4ff_t *f,
                                             const int32_t track) {
...
int32_t mp4ff_find_sample_use_offsets(const mp4ff_t *f, const int32_t track,
                                      const int64_t offset, int32_t *toskip) {
  return mp4ff_find_sample(
      f, track, offset + mp4ff_get_sample_offset(f, track, 0), toskip);
}
...
int32_t mp4ff_read_sample_v2(mp4ff_t *f, const int track, const int sample,
