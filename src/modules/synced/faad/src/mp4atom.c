...
uint64_t mp4ff_atom_read_header(mp4ff_t *f, uint8_t *atom_type,
  ...
  *header_size = 8;
  ...
  // printf("%c%c%c%c\n", atom_header[4], atom_header[5], atom_header[6],
  // atom_header[7]);
...
static int32_t mp4ff_read_stsz(mp4ff_t *f) {
  ...
  if (f->track[f->total_tracks - 1]->stsz_sample_size == 0) {
    int32_t i;
    f->track[f->total_tracks - 1]->stsz_table = (int32_t *)malloc(
        f->track[f->total_tracks - 1]->stsz_sample_count * sizeof(int32_t));
...
static int32_t mp4ff_read_stsc(mp4ff_t *f) {
  ...
  f->track[f->total_tracks - 1]->stsc_first_chunk = (int32_t *)malloc(
      f->track[f->total_tracks - 1]->stsc_entry_count * sizeof(int32_t));
  f->track[f->total_tracks - 1]->stsc_samples_per_chunk = (int32_t *)malloc(
      f->track[f->total_tracks - 1]->stsc_entry_count * sizeof(int32_t));
  f->track[f->total_tracks - 1]->stsc_sample_desc_index = (int32_t *)malloc(
      f->track[f->total_tracks - 1]->stsc_entry_count * sizeof(int32_t));
  ...
  for (i = 0; i < f->track[f->total_tracks - 1]->stsc_entry_count &&
              !f->stream->read_error;
       i++) /* CVE-2017-9255 */
  {
...
static int32_t mp4ff_read_stco(mp4ff_t *f) {
  ...
  f->track[f->total_tracks - 1]->stco_chunk_offset = (int32_t *)malloc(
      f->track[f->total_tracks - 1]->stco_entry_count * sizeof(int32_t));

  /* CVE-2017-9220 */
  if (!f->track[f->total_tracks - 1]->stco_chunk_offset)
    return f->error++;

  for (i = 0; i < f->track[f->total_tracks - 1]->stco_entry_count &&
              !f->stream->read_error;
       i++) /* CVE-2017-9256 */
  {
...
static int32_t mp4ff_read_ctts(mp4ff_t *f) {
  ...
  p_track->ctts_sample_count =
      (int32_t *)malloc(p_track->ctts_entry_count * sizeof(int32_t));
  p_track->ctts_sample_offset =
      (int32_t *)malloc(p_track->ctts_entry_count * sizeof(int32_t));
  ...
  if (p_track->ctts_sample_count == 0 || p_track->ctts_sample_offset == 0) {
    ...
    for (i = 0; i < f->track[f->total_tracks - 1]->ctts_entry_count &&
                !f->stream->read_error;
         i++) /* CVE-2017-9257 */
    {
...
static int32_t mp4ff_read_stts(mp4ff_t *f) {
  ...
  p_track->stts_sample_count =
      (int32_t *)malloc(p_track->stts_entry_count * sizeof(int32_t));
  p_track->stts_sample_delta =
      (int32_t *)malloc(p_track->stts_entry_count * sizeof(int32_t));
  ...
  if (p_track->stts_sample_count == 0 || p_track->stts_sample_delta == 0) {
    ...
    for (i = 0; i < f->track[f->total_tracks - 1]->stts_entry_count &&
                !f->stream->read_error;
         i++) /* CVE-2017-9254 */
    {
...
static int32_t mp4ff_read_mdhd(mp4ff_t *f) {
  ...
  } else // version == 0
  {
    ...
    f->track[f->total_tracks - 1]->duration =
        (temp == (uint32_t)(-1)) ? (uint64_t)(-1) : (uint64_t)(temp);
  }
  mp4ff_read_int16(f);
  mp4ff_read_int16(f);
  return 1;
