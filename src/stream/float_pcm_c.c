...
#include <limits.h>
/* Needed for BYTE_ORDER and BIG/LITTLE_ENDIAN macros. OS X doesn't
 * provide byteswap.h, and hides endian.h in /usr/include/machine, so
 * it requires a specific override.
 */
#ifdef __APPLE__
