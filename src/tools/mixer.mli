...
(* $Id: mixer.mli 2645 2006-07-17 08:28:51Z dbaelde $ *)
...
sig
  ...
  (* Check that a buffer contains no empty track, which is a good sign
   * of a failure. But you must also take care of the pure failure,
   * where source#get does nothing at all.
   * See add.ml for example. *)
  val ill : ?base:int -> t -> bool
