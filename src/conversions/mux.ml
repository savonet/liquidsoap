...
object (self)
  ...
  method private get_frame frame =
    ...
    let get until adapt_layer s =
      ...
      let inicon = Frame.content_of_type ~force:inicon frame pos (Frame.type_of_content inicon) in
      ...
      if inicon != c then self#log#f 5 "Copy-avoiding optimization isn't working!";
