        ...
        *)
        ...
        let rec aux prefix = function
          | l :: ll ->
              ...
              let v = Term.V.invokes xv (List.rev prefix) in
              ...
              let value = Term.V.Meth (l, lv, v) in
              ((vg, t), { Term.V.pos = v.Term.V.pos; value })
          | [] -> ((g, t), v)
        in
        let (g, t), v = aux [] ll in
        assert (g = []);
