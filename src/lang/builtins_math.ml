...
let () =
  ...
  add acos "acos" "Arc cosine. The argument must fall within the range [-1.0, 1.0]. \
                   Result is in radians and is between 0.0 and pi.";
  add asin "asin" "Arc sine. The argument must fall within the range [-1.0, 1.0]. \
                   Result is in radians and is between -pi/2 and pi/2.";
  add atan "atan" "Arc tangent. Result is in radians and is between -pi/2 and pi/2.";
