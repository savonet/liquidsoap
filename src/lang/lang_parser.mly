...
expr:
  ...
  | WHILE expr DO exprs DONE          { mk ~pos:$loc (App (mk ~pos:$loc($1) (Var "while"), ["", mk_fun ~pos:$loc($2) [] $2; "", mk_fun ~pos:$loc($4) [] $4])) }
  | FOR VAR GETS expr TO expr DO exprs DONE
