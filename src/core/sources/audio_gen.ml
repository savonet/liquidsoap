...
let sine f =
  new Audio.Generator.of_mono
    (new Audio.Mono.Generator.sine (Lazy.Mutexed.force Frame.audio_rate) f)

let square f =
  new Audio.Generator.of_mono
    (new Audio.Mono.Generator.square (Lazy.Mutexed.force Frame.audio_rate) f)

let saw f =
  new Audio.Generator.of_mono
    (new Audio.Mono.Generator.saw (Lazy.Mutexed.force Frame.audio_rate) f)
