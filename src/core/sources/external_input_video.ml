        ...
        let check = function
          | `Video (fmt, w, h, fps) ->
              ...
              let converter data =
                ...
                let out_width = SyncLazy.force Frame.video_width in
                let out_height = SyncLazy.force Frame.video_height in
                if
