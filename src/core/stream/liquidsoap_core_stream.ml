...
(* See liquidsoap_core_stream.mli. *)
...
module Frame_type = Liquidsoap_core_formats.Frame_type
module Generator = Generator
module MFrame = MFrame
module Metadata_base = Metadata_base
module Metadata_settings = Metadata_settings
module Subtitle_content = Subtitle_content
module VFrame = VFrame
module Video_color = Video_color
