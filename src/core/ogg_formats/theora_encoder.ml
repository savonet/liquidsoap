...
let create_encoder ~theora ~metadata () =
  ...
  in
  let width = SyncLazy.force theora.Theora_format.width in
  let height = SyncLazy.force theora.Theora_format.height in
  let picture_width = SyncLazy.force theora.Theora_format.picture_width in
  let picture_height = SyncLazy.force theora.Theora_format.picture_height in
