...
class output ~kind p =
  ...
  let name = Camomile_utils.recode_tag ~out_enc (s "name") in
  let mount, name =
  ...
  let genre = Camomile_utils.recode_tag ~out_enc (s "genre") in
  let url = s "url" in
  ...
  let description = Camomile_utils.recode_tag ~out_enc (s "description") in
