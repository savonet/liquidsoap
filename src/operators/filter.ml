...
let () =
  Lang.add_operator "filter"
    [ "freq", Lang.float_getter_t 1, None, None ;
      ...
      "wetness", Lang.float_getter_t 3, Some (Lang.float 1.), Some "How much of the original signal should be added (1. means only filtered and 0. means only original signal).";
