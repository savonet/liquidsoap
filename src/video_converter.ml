...
type yuv_frame = 
  { 
    ...
    y            : (int, Bigarray.int8_unsigned_elt, Bigarray.c_layout) Bigarray.Array1.t;
    y_stride     : int;
    u            : (int, Bigarray.int8_unsigned_elt, Bigarray.c_layout) Bigarray.Array1.t;
    v            : (int, Bigarray.int8_unsigned_elt, Bigarray.c_layout) Bigarray.Array1.t;
    uv_stride    : int
  }
type frame_data = 
  | Rgb of rgb_frame
